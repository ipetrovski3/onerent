                            ...
                            <div class="car_product_item">
                                ...
                                <div class="product_content">
                                    ...
                                    <ul class="nav">
                                        ...
                                        <li><i class="icon-gear1"></i> <span>{{ $transmissions[$car->transmission_type] }}</span></li>
                                        <li title="Fuel Type"><img src="img/icon/p-cat-icon-1.png" class="mr-1 ml-2" alt=""><span>{{ $engines[$car->engine_type] }}</span></li>
                                        <li><i class="icon-engine"></i><span>{{ $engines[$car->engine_type] }}</span></li>
