    ...
    Object.assign(s.config, {
      ...
      enterFullScreen: function enterFullScreen() {
        ...
        if (!1 === e.options.useFakeFullscreen && d.IS_IOS && d.HAS_IOS_FULLSCREEN && "function" == typeof e.media.originalNode.webkitEnterFullscreen && e.media.originalNode.canPlayType((0, f.getTypeFromFile)(e.media.getSrc()))) e.media.originalNode.webkitEnterFullscreen();else {
          ...
          }, 500), t) e.node.style.width = "100%", e.node.style.height = "100%";else for (var o = e.container.querySelectorAll("embed, object, video"), a = o.length, s = 0; s < a; s++) {
      ...
      exitFullScreen: function exitFullScreen() {
        ...
        if (clearTimeout(e.containerSizeTimeout), d.HAS_TRUE_NATIVE_FULLSCREEN && (d.IS_FULLSCREEN || e.isFullScreen) && d.cancelFullScreen(), (0, c.removeClass)(r["default"].documentElement, e.options.classPrefix + "fullscreen"), (0, c.removeClass)(e.container, e.options.classPrefix + "container-fullscreen"), e.options.setDimensions) {
          if (e.container.style.width = e.normalWidth + "px", e.container.style.height = e.normalHeight + "px", t) e.node.style.width = e.normalWidth + "px", e.node.style.height = e.normalHeight + "px";else for (var n = e.container.querySelectorAll("embed, object, video"), o = n.length, i = 0; i < o; i++) {
      ...
      return a(e, [{
          ...
          if (e = void 0 === e || e, !t.controlsAreVisible && t.isVideo) {
            if (e) !function () {
              ...
              for (var n = t.container.querySelectorAll("." + t.options.classPrefix + "control"), o = 0, i = n.length; o < i; o++) {
                y.removeClass(n[o], t.options.classPrefix + "offscreen"), n[o].style.display = "";
              }
          ...
          if (e = void 0 === e || e, !0 === t || !(!n.controlsAreVisible || n.options.alwaysShowControls || n.paused && 4 === n.readyState && (!n.options.hideVideoControlsOnLoad && n.currentTime <= 0 || !n.options.hideVideoControlsOnPause && n.currentTime > 0) || n.isVideo && !n.options.hideVideoControlsOnLoad && !n.readyState || n.ended)) {
            if (e) !function () {
              ...
              for (var o = n.container.querySelectorAll("." + n.options.classPrefix + "control"), i = 0, r = o.length; i < r; i++) {
                y.addClass(o[i], n.options.classPrefix + "offscreen"), o[i].style.display = "";
              }
        ...
        value: function value() {
          ...
          for (var l = e.container.querySelectorAll("object, embed, iframe, video"), d = e.height, u = e.width, c = i, f = d * i / u, p = u * r / d, m = r, h = p > i == !1, v = h ? Math.floor(c) : Math.floor(p), y = h ? Math.floor(f) : Math.floor(m), g = h ? i + "px" : v + "px", b = h ? y + "px" : r + "px", E = 0, S = l.length; E < S; E++) {
            l[E].style.height = b, l[E].style.width = g, e.media.setSize && e.media.setSize(g, b), l[E].style.marginLeft = Math.floor((i - v) / 2) + "px", l[E].style.marginTop = 0;
          }
        }
      }, {
        key: "setDimensions",
  ...
  19: [function (e, t, n) {
    ...
    var i = "function" == typeof Symbol && "symbol" == _typeof(Symbol.iterator) ? function (e) {
      ...
      create: function create(e, t, n) {
        ...
        for (var y = a["default"].html5media.properties, g = a["default"].html5media.events.concat(["click", "mouseover", "mouseout"]), b = function b(t) {
          if ("error" !== t.type) {
  ...
  21: [function (e, t, n) {
    ...
    var i = "function" == typeof Symbol && "symbol" == _typeof(Symbol.iterator) ? function (e) {
      ...
      create: function create(e, t, n) {
        ...
        for (var p = a["default"].html5media.properties, m = a["default"].html5media.events.concat(["click", "mouseover", "mouseout"]), h = function h(t) {
          if ("error" !== t.type) {
            var n = (0, l.createEvent)(t.type, e);
            e.dispatchEvent(n);
          }
        ...
        }, n && n.length > 0) for (var g = 0, b = n.length; g < b; g++) {
